//create varialbe to hold db connection
let db;

//establish a connection to IndexDB datgabase called "budget_tracker" and set it to version 1
...
function uploadEntry() {
    ...
    //upon a successfull getAll() execution run this
